...
dtmf_signal = dtmf_dial('###0000927782892999200488490200994338758738****37737', 24e3);
...
x_fft = fft(dtmf_signal, length(dtmf_signal));
figure;
plotting(length(dtmf_signal), 24e3, x_fft, unwrap(angle(fftshift(x_fft))))